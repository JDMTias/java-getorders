package com.lambdaschool.getorders2;
...
public class SeedData implements CommandLineRunner {
     ...
     */
    @Autowired
    private CustomerRepositories custrepo;
     ...
     */
    @Autowired
    private OrdersRepositories ordersrepos;

    /**
     * Connects the payment table to this SeedData method
     */
    @Autowired
    private PaymentRepositories paymentrepos;

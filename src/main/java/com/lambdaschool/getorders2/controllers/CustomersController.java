package com.lambdaschool.getorders2.controllers;

import com.lambdaschool.getorders2.models.Customer;
import com.lambdaschool.getorders2.services.CustomerServices;
...
public class CustomersController {
    ...
    public ResponseEntity<?> findCustomerCode(@PathVariable long custcode) {
...
//    getting customers, missing agents, orders and payments/id within orders.
